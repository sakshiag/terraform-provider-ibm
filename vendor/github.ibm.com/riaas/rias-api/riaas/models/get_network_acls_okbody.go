...
type GetNetworkAclsOKBody struct {
	...
	// network acls
	NetworkAcls GetNetworkAclsOKBodyNetworkAcls `json:"network_acls,omitempty"`
...
func (m *GetNetworkAclsOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetNetworkAclsOKBody) validateFirst(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsOKBody) validateLimit(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsOKBody) validateTotalCount(formats strfmt.Registry) error {
...
func (m *GetNetworkAclsOKBody) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetNetworkAclsOKBody) UnmarshalBinary(b []byte) error {
