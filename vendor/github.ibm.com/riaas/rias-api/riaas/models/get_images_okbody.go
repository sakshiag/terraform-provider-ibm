...
type GetImagesOKBody struct {
	...
	// images
	Images GetImagesOKBodyImages `json:"images,omitempty"`
...
func (m *GetImagesOKBody) validateFirst(formats strfmt.Registry) error {
...
func (m *GetImagesOKBody) validateLimit(formats strfmt.Registry) error {
...
func (m *GetImagesOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *GetImagesOKBody) validateTotalCount(formats strfmt.Registry) error {
