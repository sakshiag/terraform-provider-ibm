...
func (m *PostInstancesParamsBodyPrimaryNetworkInterfaceSubnet) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostInstancesParamsBodyPrimaryNetworkInterfaceSubnet) validateName(formats strfmt.Registry) error {
...
func (m *PostInstancesParamsBodyPrimaryNetworkInterfaceSubnet) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostInstancesParamsBodyPrimaryNetworkInterfaceSubnet) UnmarshalBinary(b []byte) error {
