...
func (m *PatchVolumesIDParamsBodyProfile) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PatchVolumesIDParamsBodyProfile) validateName(formats strfmt.Registry) error {
...
func (m *PatchVolumesIDParamsBodyProfile) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PatchVolumesIDParamsBodyProfile) UnmarshalBinary(b []byte) error {
