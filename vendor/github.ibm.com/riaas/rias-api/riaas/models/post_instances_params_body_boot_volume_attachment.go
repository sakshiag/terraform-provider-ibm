...
type PostInstancesParamsBodyBootVolumeAttachment struct {
	...
	// resource group
	ResourceGroup *PostInstancesParamsBodyBootVolumeAttachmentResourceGroup `json:"resource_group,omitempty"`
...
func (m *PostInstancesParamsBodyBootVolumeAttachment) validateResourceGroup(formats strfmt.Registry) error {
...
func (m *PostInstancesParamsBodyBootVolumeAttachment) validateTags(formats strfmt.Registry) error {
