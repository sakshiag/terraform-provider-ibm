...
type GetKeysOKBody struct {
	...
	// keys
	Keys GetKeysOKBodyKeys `json:"keys,omitempty"`
...
func (m *GetKeysOKBody) validateFirst(formats strfmt.Registry) error {
...
func (m *GetKeysOKBody) validateLimit(formats strfmt.Registry) error {
...
func (m *GetKeysOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *GetKeysOKBody) validateTotalCount(formats strfmt.Registry) error {
