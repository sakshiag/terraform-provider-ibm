...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodySubnet) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodySubnet) validateName(formats strfmt.Registry) error {
...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodySubnet) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodySubnet) UnmarshalBinary(b []byte) error {
