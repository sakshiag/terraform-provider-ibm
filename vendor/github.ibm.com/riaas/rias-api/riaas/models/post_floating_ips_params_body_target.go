...
func (m *PostFloatingIpsParamsBodyTarget) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostFloatingIpsParamsBodyTarget) validateName(formats strfmt.Registry) error {
...
func (m *PostFloatingIpsParamsBodyTarget) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostFloatingIpsParamsBodyTarget) UnmarshalBinary(b []byte) error {
