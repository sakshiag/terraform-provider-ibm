...
// swagger:model resource_reference
...
func (m *ResourceReference) validateHref(formats strfmt.Registry) error {
...
func (m *ResourceReference) validateName(formats strfmt.Registry) error {
