...
func (m *GetImagesOKBodyFirst) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetImagesOKBodyFirst) validateHref(formats strfmt.Registry) error {
...
func (m *GetImagesOKBodyFirst) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GetImagesOKBodyFirst) UnmarshalBinary(b []byte) error {
