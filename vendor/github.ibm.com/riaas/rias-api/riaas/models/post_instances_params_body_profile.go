...
func (m *PostInstancesParamsBodyProfile) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostInstancesParamsBodyProfile) validateName(formats strfmt.Registry) error {
...
func (m *PostInstancesParamsBodyProfile) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostInstancesParamsBodyProfile) UnmarshalBinary(b []byte) error {
