...
func (m *PostVolumesParamsBodyEncryptionKey) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostVolumesParamsBodyEncryptionKey) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostVolumesParamsBodyEncryptionKey) UnmarshalBinary(b []byte) error {
