...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodyResourceGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodyResourceGroup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostInstancesInstanceIDNetworkInterfacesParamsBodyResourceGroup) UnmarshalBinary(b []byte) error {
