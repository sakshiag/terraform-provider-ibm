...
type GetFlavorsOKBody struct {
	...
	// first
	First *GetFlavorsOKBodyFirst `json:"first,omitempty"`

	// flavors
	Flavors GetFlavorsOKBodyFlavors `json:"flavors,omitempty"`
...
func (m *GetFlavorsOKBody) validateFirst(formats strfmt.Registry) error {
...
func (m *GetFlavorsOKBody) validateLimit(formats strfmt.Registry) error {
...
func (m *GetFlavorsOKBody) validateNext(formats strfmt.Registry) error {
...
func (m *GetFlavorsOKBody) validateTotalCount(formats strfmt.Registry) error {
