...
func (m *PostSubnetsParamsBodyVpc) validateName(formats strfmt.Registry) error {
...
func (m *PostSubnetsParamsBodyVpc) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostSubnetsParamsBodyVpc) UnmarshalBinary(b []byte) error {
