...
func (m *PostSubnetsParamsBodyResourceGroup) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostSubnetsParamsBodyResourceGroup) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostSubnetsParamsBodyResourceGroup) UnmarshalBinary(b []byte) error {
