...
// ServerProfile ServerPackage
// swagger:model server_profile
type ServerProfile struct {

	// The CRN for this serverprofile
	...
	// The URL for this server profile
	// Pattern: ^http(s)?:\/\/([^\/?#]*)([^?#]*)(\?([^#]*))?(#(.*))?$
	Href string `json:"href,omitempty"`

	// The user-defined name for this server profile
...
func (m *ServerProfile) validateGeneration(formats strfmt.Registry) error {
...
func (m *ServerProfile) validateHref(formats strfmt.Registry) error {
...
func (m *ServerProfile) validateName(formats strfmt.Registry) error {
