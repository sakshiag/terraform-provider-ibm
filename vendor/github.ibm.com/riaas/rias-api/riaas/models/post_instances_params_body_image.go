...
func (m *PostInstancesParamsBodyImage) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PostInstancesParamsBodyImage) validateName(formats strfmt.Registry) error {
...
func (m *PostInstancesParamsBodyImage) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PostInstancesParamsBodyImage) UnmarshalBinary(b []byte) error {
