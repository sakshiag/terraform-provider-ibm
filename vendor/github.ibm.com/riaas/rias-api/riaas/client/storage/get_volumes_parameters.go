...
// WithTag adds the tag to the get volumes params
func (o *GetVolumesParams) WithTag(tag *string) *GetVolumesParams {
	o.SetTag(tag)
	return o
}

// SetTag adds the tag to the get volumes params
func (o *GetVolumesParams) SetTag(tag *string) {
	o.Tag = tag
}
