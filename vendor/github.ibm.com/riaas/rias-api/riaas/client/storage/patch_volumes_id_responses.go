...
func (o *PatchVolumesIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPatchVolumesIDDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewPatchVolumesIDDefault creates a PatchVolumesIDDefault with default headers values
func NewPatchVolumesIDDefault(code int) *PatchVolumesIDDefault {
	return &PatchVolumesIDDefault{
		_statusCode: code,
	}
}

/*PatchVolumesIDDefault handles this case with default header values.

unexpectederror
*/
type PatchVolumesIDDefault struct {
	_statusCode int

	Payload *models.Riaaserror
}

// Code gets the status code for the patch volumes ID default response
func (o *PatchVolumesIDDefault) Code() int {
	return o._statusCode
}

func (o *PatchVolumesIDDefault) Error() string {
	return fmt.Sprintf("[PATCH /volumes/{id}][%d] PatchVolumesID default  %+v", o._statusCode, o.Payload)
}

func (o *PatchVolumesIDDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
