...
// NewGetRegionsNameParams creates a new GetRegionsNameParams object
// with the default values initialized.
func NewGetRegionsNameParams() *GetRegionsNameParams {
	var ()
	return &GetRegionsNameParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetRegionsNameParamsWithTimeout creates a new GetRegionsNameParams object
...
// NewGetRegionsNameParamsWithContext creates a new GetRegionsNameParams object
...
// NewGetRegionsNameParamsWithHTTPClient creates a new GetRegionsNameParams object
...
/*GetRegionsNameParams contains all the parameters to send to the API endpoint
for the get regions name operation typically these are written to a http.Request
*/
...
func (o *GetRegionsNameParams) WithContext(ctx context.Context) *GetRegionsNameParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetRegionsNameParams) WithName(name string) *GetRegionsNameParams {
	o.SetName(name)
	return o
}
