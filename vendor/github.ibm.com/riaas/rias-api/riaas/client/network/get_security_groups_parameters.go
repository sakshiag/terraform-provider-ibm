...
func (o *GetSecurityGroupsParams) WithLimit(limit *int32) *GetSecurityGroupsParams {
	o.SetLimit(limit)
	return o
}
...
func (o *GetSecurityGroupsParams) WithStart(start *string) *GetSecurityGroupsParams {
	o.SetStart(start)
	return o
}
...
// WithTag adds the tag to the get security groups params
func (o *GetSecurityGroupsParams) WithTag(tag *string) *GetSecurityGroupsParams {
	o.SetTag(tag)
	return o
}
...
func (o *GetSecurityGroupsParams) WithVpcID(vpcID *string) *GetSecurityGroupsParams {
	o.SetVpcID(vpcID)
	return o
}
