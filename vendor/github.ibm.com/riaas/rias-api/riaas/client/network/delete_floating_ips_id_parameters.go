...
// NewDeleteFloatingIpsIDParams creates a new DeleteFloatingIpsIDParams object
// with the default values initialized.
func NewDeleteFloatingIpsIDParams() *DeleteFloatingIpsIDParams {
	var ()
	return &DeleteFloatingIpsIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteFloatingIpsIDParamsWithTimeout creates a new DeleteFloatingIpsIDParams object
...
// NewDeleteFloatingIpsIDParamsWithContext creates a new DeleteFloatingIpsIDParams object
...
// NewDeleteFloatingIpsIDParamsWithHTTPClient creates a new DeleteFloatingIpsIDParams object
...
/*DeleteFloatingIpsIDParams contains all the parameters to send to the API endpoint
for the delete floating ips ID operation typically these are written to a http.Request
*/
...
func (o *DeleteFloatingIpsIDParams) WithTimeout(timeout time.Duration) *DeleteFloatingIpsIDParams {
...
func (o *DeleteFloatingIpsIDParams) WithContext(ctx context.Context) *DeleteFloatingIpsIDParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteFloatingIpsIDParams) WithID(id string) *DeleteFloatingIpsIDParams {
	o.SetID(id)
	return o
}
...
func (o *DeleteFloatingIpsIDParams) WithVersion(version string) *DeleteFloatingIpsIDParams {
...
func (o *DeleteFloatingIpsIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
