...
// NewDeleteLoadBalancersIDPoolsPoolIDParams creates a new DeleteLoadBalancersIDPoolsPoolIDParams object
// with the default values initialized.
func NewDeleteLoadBalancersIDPoolsPoolIDParams() *DeleteLoadBalancersIDPoolsPoolIDParams {
	var ()
	return &DeleteLoadBalancersIDPoolsPoolIDParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteLoadBalancersIDPoolsPoolIDParamsWithTimeout creates a new DeleteLoadBalancersIDPoolsPoolIDParams object
...
// NewDeleteLoadBalancersIDPoolsPoolIDParamsWithContext creates a new DeleteLoadBalancersIDPoolsPoolIDParams object
...
// NewDeleteLoadBalancersIDPoolsPoolIDParamsWithHTTPClient creates a new DeleteLoadBalancersIDPoolsPoolIDParams object
...
/*DeleteLoadBalancersIDPoolsPoolIDParams contains all the parameters to send to the API endpoint
for the delete load balancers ID pools pool ID operation typically these are written to a http.Request
*/
